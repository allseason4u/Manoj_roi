...
const AdminIncomePage = () => {
  ...
  return (
    <div className="p-6 bg-white text-gray-800 min-h-screen">
      <h2 className="text-3xl font-bold mb-6 text-blue-600">Inherit Payout</h2>
          ...
          <table className="min-w-full text-sm text-left border-collapse">
            <thead>
              <tr className="bg-gray-100 text-gray-700 uppercase text-xs tracking-wider">
                ...
                <th className="px-4 py-3">Memberid</th>
            ...
            <tbody>
              {incomes.map((income, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-blue-600">{income.memberid}</td>
